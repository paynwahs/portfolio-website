    ...
    for (let screen of TOTAL_SCREENS) {
      ...
      if (fullyVisible || partiallyVisible) {
        if (partiallyVisible && !screen.alreadyRendered) {
          ...
          // Fit new values into the subject and have it multicasted to the observer subscribed to listen to the subject. In this case its gonna be from different components
